...
SCRAPE_INTER_CREATOR_DELAY_MAX_SECONDS: Final[float] = max(
    ...
    float(_env_value("SCRAPE_INTER_CREATOR_DELAY_MAX_SECONDS", "120")),
)
...
SCRAPE_LONG_BREAK_MIN_SECONDS: Final[float] = max(
    0.0, float(_env_value("SCRAPE_LONG_BREAK_MIN_SECONDS", "240"))
)
SCRAPE_LONG_BREAK_MAX_SECONDS: Final[float] = max(
    SCRAPE_LONG_BREAK_MIN_SECONDS,
    float(_env_value("SCRAPE_LONG_BREAK_MAX_SECONDS", "420")),
)
EXTENSION_SCRAPE_TASK_TIMEOUT_SECONDS: Final[float] = max(
    30.0,
    float(_env_value("EXTENSION_SCRAPE_TASK_TIMEOUT_SECONDS", "300")),
)
EXTENSION_SCRAPE_TASK_LEASE_SECONDS: Final[float] = max(
    30.0,
    float(_env_value("EXTENSION_SCRAPE_TASK_LEASE_SECONDS", "120")),
)
EXTENSION_API_TOKEN: Final[str] = _env_optional("EXTENSION_API_TOKEN")
