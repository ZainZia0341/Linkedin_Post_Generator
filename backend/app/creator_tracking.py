...
def _normalize_post_record(post: dict[str, Any], profile: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "repost_text": str(post.get("repost_text", "")),
        "original_post_text": str(post.get("original_post_text", "")),
        "original_author_name": str(post.get("original_author_name", "")),
        "original_author_url": str(post.get("original_author_url", "")),
